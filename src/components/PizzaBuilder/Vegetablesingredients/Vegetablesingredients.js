...
import classes from "./Vegetablesingredients.module.css";
...
const Vagetablesingredients = ({ type, fixed }) => {
  const types = {
  ...
  return (
    <div className={classes.Vagetablesingredients} style={types[type]}></div>
  );
}

export default React.memo(Vagetablesingredients);