...
import classes from "./Vegetablesingr.module.css";
...
const Vegetablesingr = ({ type, fixed }) => {
  const types = {
  ...
  return (
    <div className={classes.Vegetablesingr} style={types[type]}></div>
  );
}

export default React.memo(Vegetablesingr);